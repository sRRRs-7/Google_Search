...
export const Results = () => {
  const { results: { results, image_results }, getResults, searchTerm, isLoading } = useStateContext();
      ...
      return (
        <div className="flex flex-wrap justify-center items-center">
          {image_results?.map(({image, link: { href, title }, index}) => (
            <a className="sm:p-3" href={href} key={index} target="_blank" rel="noreferrer">
